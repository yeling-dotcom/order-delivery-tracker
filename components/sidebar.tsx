...
const links=[{href:"/",icon:"◫",label:"Dashboard"},{href:"/orders",icon:"▤",label:"Orders"},{href:"/deliveries",icon:"◇",label:"Deliveries"},{href:"/customers",icon:"◎",label:"Customers"},{href:"/account",icon:"⚙",label:"Account"}];
